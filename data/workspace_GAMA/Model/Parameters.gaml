...
global {
	...
	//simulation step
	float step<-1#h;
	date starting_date <- date([2020,3,15]);
	...
	float basic_viral_release <- 4.0; //Viral load released in the environment by infectious individual
	float basic_viral_decrease <- 0.50; //Value to decrement the viral load in the environment
