...
O exemplo acima criará uma espécie chamada \textit{dummy_model}, filho da espécie abstrata \textit{model}, a partir da qual as simulações serão instanciadas. 

A importação de um modelo pode ser realizada de duas formas: por herança ou importação direta.

\figura{import_1}{estrutura básica de um modelo GAML}{basicmodel}{width=0.75\textwidth}

\figura{import_2}{estrutura básica de um modelo GAML}{basicmodel}{width=0.75\textwidth}
