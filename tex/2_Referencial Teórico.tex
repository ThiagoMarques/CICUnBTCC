...
Divirta-se com uma interface gráfica amigável, limpa e customizável;
Faça mapas extremamente sofisticados com recursos de estilização raramente comparáveis;
Não se preocupe com o formato do seu dado. A capacidade de leitura de diversos tipos de arquivos geoespaciais é fantástica e sem burocracias;
Explore e instale dezenas de complementos (plugins) desenvolvidos pela comunidade do QGIS ao redor do mundo;
Use a robustez de outros softwares como GRASS-GIS, SAGA-GIS, TauDEM, R, PostGIS, etc dentro do QGIS. O QGIS funciona como uma plataforma guarda-chuva para outros projetos de SIG, matemática e banco de dados. Ou seja: instale ele e terá acesso a outros projetos;
