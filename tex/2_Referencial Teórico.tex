...
\figura{Passaros}{2_3_3_Passaros.jpg}{Passaros}{width=0.75\textwidth}
...
\figura{2_4_1_Geoprocessamento}{Componentes de um sistema de informação geográfica}{Geoprocessamento Imagem}{width=0.75\textwidth}
...
\figura{metamodelo_GAMA}{meta-modelo do GAML na forma de um framework. Fonte: \cite[p.2]{} }{metamodelo1}{width=0.75\textwidth}
...
\figura{2_8_Rota_de_fuga}{Simulação da evacuação de um incêndio.(A) sem bloqueio, (B) com bloqueio depois de 10 segundos, (C) com bloqueio após 45 segundos\cite{bonabeau2002agent}}{Incêndio}{width=0.75\textwidth}
